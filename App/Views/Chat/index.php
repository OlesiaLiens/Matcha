...
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #2d2d2d !important;">
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
			...
			<li class="nav-item active"><a class="nav-link" href="/chat/index">Chat</a></li>
		...
		<div class="col-xs-12 col-md-8 col-xl-6 chat chat-msg-block">
			<div class="card">
				...
				<div class="card-footer">
					<div class="input-group">
						<textarea id="msgInput" class="form-control type_msg"
...
<!--        <div class="row"-->
<!--             style="position: absolute; bottom: 0px; display: block !important; background-color: #2b2b2b; width: 120vh; height: 90px;">-->
<!--            <div class="container">-->
