<!DOCTYPE html>
<!-- saved from url=(0031)http://localhost:5000/messenger -->
<html lang="en">
<head>
	...
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="/chat/index">Chat</a></li>
...
<div id="app">
	<section class="App ant-layout">
		<div><label class="toggle-menu"> ☰ Menu</label><input type="checkbox" name="toggle" id="menu"
															  class="toggle-menu">
			<div></div>
		</div>
		<div class="container-no-wrap">
			<div class="people-list-container"><span class="ant-input-search ant-input-affix-wrapper"
													 style="width: 90%;"><input placeholder="search" class="ant-input"
																				type="text" value=""><span
							class="ant-input-suffix"><i aria-label="icon: search" tabindex="-1"
														class="anticon anticon-search ant-input-search-icon"><svg
									viewBox="64 64 896 896" focusable="false" class="" data-icon="search" width="1em"
			...
			<div class="chat-container">
				<div class="choose-chat">Choose a user to start a chat</div>
			</div>
		</div>
	</section>
</div>
...
<style>
	[ant-click-animating-without-extra-node='true']::after, .ant-click-animating-node {
		--antd-wave-shadow-color : rgb(32, 146, 251);
	}</style>
</body>
</html>
