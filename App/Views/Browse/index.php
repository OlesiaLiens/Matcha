		...
		<div id="menuCol" class="col-3 col-xs-12">
			<div class="row"
				...
				<div id="innerMenuCol" class="col">
					...
					<div class="row mt-3">
						<div class="col text-center"><h3 class="text-white">Sort by</h3></div>
					</div>
					...
					<div class="row mt-3">
						<div class="col text-center"><h3 class="text-white">Filter criteria</h3></div>
					</div>
					...
					<div id="ageBtnRow" class="row justify-content-center text-center">
						<button class="btn btn-primary m-3" type="button" data-toggle="collapse" data-target="#ageSets"
								aria-expanded="false" aria-controls="ageSets">Age
						</button>
					</div>
					...
					<div id="distBtnRow" class="row justify-content-center text-center">
						<button class="btn btn-primary m-3" type="button" data-toggle="collapse" data-target="#distSets"
								aria-expanded="false" aria-controls="distSets">Distance
						</button>
					</div>
					...
					<div id="rateBtnRow" class="row justify-content-center text-center">
						<button class="btn btn-primary m-3" type="button" data-toggle="collapse" data-target="#rateSets"
								aria-expanded="false" aria-controls="rateSets">Rating
						</button>
					</div>
					...
					<div id="tagsBtnRow" class="row justify-content-center text-center">
						<button class="btn btn-primary m-3" type="button" data-toggle="collapse" data-target="#tagsSets"
								aria-expanded="false" aria-controls="tagSets">Required Tags
						</button>
					</div>
