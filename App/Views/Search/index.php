...
-->
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link" href="http://localhost:1997/account/index">Account</a></li>
            <li class="nav-item"><a class="nav-link" href="http://localhost:1997/info/info">Information</a></li>
            <li class="nav-item"><a class="nav-link" href="http://localhost:1997/notification/index">Notification</a></li>
            <li class="nav-item"><a class="nav-link" href="http://localhost:1997/settings/index">Settings</a></li>
            <li class="nav-item active"><a class="nav-link" href="http://localhost:1997/search/index">Search</a></li>
            <li class="nav-item"><a class="nav-link" href="http://localhost:1997/chat/index">Chat</a></li>
            <li class="nav-item"><a class="nav-link" href="http://localhost:1997/logout/index">Logout</a></li>
        </ul>
    </div>
</nav>
...
<div id="jumbo" class="container jumbotron">
    ...
    <div class="row justify-content-center">
        <div class="col-xs-12 col-sm-4 col-md-2">
            <select id="minAge" class="custom-select custom-select">
        ...
        <div class="col-xs-12 col-sm-4 col-md-2">
            <select id="maxAge" class="custom-select custom-select">
